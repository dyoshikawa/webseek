...
description: >-
  ...
  and draft GitHub release, wait for CI to turn green, run the merge-pr skill to merge the release
  PR, then wait for the Publish workflow to publish the npm package and finalize
  the GitHub release. Use when the user wants to draft and merge a release in
  one go.
targets:
  - "*"
---
