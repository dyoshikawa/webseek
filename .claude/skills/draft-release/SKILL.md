...
name: draft-release
description: >-
  Prepare a new npm release: bump the version, open a release PR, and create a
  draft GitHub release. Publishing is automated by the Publish workflow once the
